    ...
    <main class="page-content">
        ...
        <div class="row">
            ...
            <div class="col-12 card mg-t-20-force">
                <div class="card-body">
                    <h2 class="card-title">Ordenes de Transportes</h2>
                    ...
                    <div class="row">
                        ...
                        <!-- <div class="col-12 d-flex justify-content-end mg-b-10">
                            <a href="../Ordenes/cargarOrdenesCron" class="btn btn-primary waves-effect col-12 col-lg-1">Agregar Acción de Contacto</a>
                        </div> -->
                        <div class="col-12">
                            ...
                            <div class="row">
                                ...
                                <div class="table-responsive">
                                    <?php
                                    $nombreTabla = "ordenes_table";
                                    $nombreCampos = ["ID", "Nº ORDEN", "CONDUCTOR", "CLIENTE", "FECHA INICIO", "LUGAR CARGA", "TIPO", "ESTADO", "GESTIONAR"];
                                    $nombreCamposFooter = ["ID", "Nº ORDEN", "CONDUCTOR", "CLIENTE", "FECHA INICIO", "LUGAR CARGA", "TIPO", "ESTADO", "GESTIONAR"];
