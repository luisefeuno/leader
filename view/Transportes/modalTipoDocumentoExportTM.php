        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    <div id="botonesDocumentos" class="row d-flex justify-content-center">
                        <button data-tipodocumento='A' class="printDocumento btn btn-danger btn-icon-text col-auto">
                            <i class="fas fa-file-medical tx-25"></i>
                            <span>ADMITASE</span>
                        </button>
                        <button data-tipodocumento='E' class="printDocumento btn btn-warning btn-icon-text col-auto">
                            <i class="fas fa-file-excel tx-25"></i>
                            <span>ENTREGUESE</span>
                        </button>
                        ...
                        <button data-tipodocumento='T' class="printDocumento btn btn-secondary btn-icon-text col-auto">
                            <i class="fas fa-file-invoice tx-25"></i>
                        ...
                        <button data-tipodocumento='CMR' class="printDocumento btn btn-purple  btn-icon-text col-auto">
                            <i class="fa-solid fa-file-arrow-down tx-25"></i>
                            <span>CMR</span>
                        </button>
