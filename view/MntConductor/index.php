    ...
    <main class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item" aria-current="page">Conductores</li>
                    </ol>
                </nav>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-12 card mg-t-20-force">
                <div class="card-body">
                    <h2 class="card-title">Conductores</h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <input type="hidden" id="idConductor" value="<?php echo $_GET["idConductor"] ?>">
                                <div class="table-responsive order-mobile-first">
                                    <?php
                                    $nombreTabla = "conductores_table";
                                    $nombreCampos = ["ID", "Nombre","NIF","Email","Dirección","Población","Provincia"];
                                    $nombreCamposFooter = ["ID",
                            "<input type='text' class='form-control' id='FootNombre' placeholder='Buscar Nombre'>", 
                            "<input type='text' class='form-control' id='FootNif' placeholder='Buscar Nif'>","Email","Dirección","Población","Provincia"];
